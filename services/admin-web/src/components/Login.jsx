...
export default function Login({ onLogin }) {
  return (
    <div className="min-h-screen bg-[#03060D] text-slate-300 font-sans selection:bg-cyan-500/30 flex items-center justify-center px-4 relative overflow-hidden">
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-cyan-900/20 via-[#03060D] to-[#03060D] pointer-events-none"></div>
      ...
      <div className="w-full max-w-md relative z-10 animate-fade-in">
        ...
        <div className="relative bg-gradient-to-b from-[#0B1221]/90 to-[#050B14]/90 border border-cyan-900/40 rounded-3xl p-10 text-center shadow-[0_0_50px_rgba(6,182,212,0.15)] backdrop-blur-xl">
          ...
          <button
            onClick={onLogin}
            className="w-full mt-10 bg-white/5 hover:bg-white/10 border border-white/10 text-white font-bold py-4 rounded-xl flex items-center justify-center gap-3 transition-all duration-300 shadow-[0_4px_20px_rgba(0,0,0,0.5)] hover:shadow-[0_0_20px_rgba(6,182,212,0.2)] hover:border-cyan-400/30 hover:-translate-y-1 active:translate-y-0"
          >
