...
export default function AutomationsPage() {
  ...
  return (
    <div ref={wrapperRef} className="flex-1 w-full animate-fade-in flex flex-col relative group bg-[var(--color-background)]">
      <iframe
        src="/n8n/"
        title="CamTech Workflow Automations"
      ...
      <button
        ...
        className="absolute bottom-6 right-8 p-3 rounded-full bg-orange-600 hover:bg-orange-500 text-white shadow-lg opacity-50 hover:opacity-100 transition-all z-50 flex items-center justify-center group-hover:opacity-100"
