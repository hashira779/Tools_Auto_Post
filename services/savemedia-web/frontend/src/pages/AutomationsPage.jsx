  ...
  return (
    <div className="w-full flex flex-col items-center pb-24 text-slate-200 overflow-x-hidden">
      ...
      <section ref={scrollyContainerRef} className="w-full max-w-5xl mx-auto px-4 sm:px-6 relative h-[250vh] sm:h-[300vh]">
        ...
        <div className="sticky top-20 sm:top-24 w-full bg-[#070D18]/95 border border-orange-900/30 rounded-3xl p-5 sm:p-10 shadow-2xl backdrop-blur-2xl text-left overflow-hidden">
          
          {/* Section Header & Apple Scroll Indicator */}
          <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-3 pb-6 border-b border-orange-950/80 mb-6">
            <div>
              <span className="text-xs font-mono uppercase tracking-widest text-orange-400 font-bold">Autonomous Engine</span>
              <h2 className="text-2xl sm:text-3xl font-bold text-white mt-0.5">Autonomous Intelligence in Motion</h2>
            </div>
            ...
            <div className="flex items-center gap-3">
              ...
              <span className="text-xs font-mono font-bold text-orange-400">0{storyStage + 1}/04</span>
            </div>
          </div>
              ...
              {storyStages.map((st) => (
                <div
                  ...
                  className={`p-4 sm:p-5 rounded-2xl border transition-all duration-500 cursor-pointer ${
                    storyStage === st.id
                      ? 'bg-[#131B2E] border-orange-500/60 shadow-[0_0_30px_rgba(249,115,22,0.25)] scale-[1.02]'
