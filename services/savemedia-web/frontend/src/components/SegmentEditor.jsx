    ...
    <div className="bg-[var(--color-surface-2)] rounded-2xl border border-white/10 overflow-hidden animate-fade-in shadow-xl">
      ...
      <div className="p-6 space-y-6">
        ...
        <div className="space-y-2">
          <label className="text-xs font-bold text-gray-500 uppercase tracking-wider">Original Khmer</label>
        ...
        {/* English Edit */}
        <div className="space-y-2">
          <label className="text-xs font-bold text-gray-500 uppercase tracking-wider">Natural English</label>
          <textarea
            value={editedEnglish}
            onChange={(e) => setEditedEnglish(e.target.value)}
            className="w-full h-32 bg-black/40 border border-white/10 rounded-xl px-4 py-3 text-white focus:outline-none focus:ring-2 focus:ring-purple-500 transition-all resize-none leading-relaxed"
        ...
        <div className="flex flex-wrap gap-3 pt-2">
          <button
            onClick={handleSave}
            disabled={isSaving}
            className="flex-1 min-w-[140px] flex items-center justify-center gap-2 py-3 bg-purple-600 hover:bg-purple-500 text-white rounded-xl font-bold transition-all shadow-lg shadow-purple-500/20 disabled:opacity-50"
          >
          ...
          <button
            ...
            disabled={isSaving}
            className="flex-1 min-w-[140px] flex items-center justify-center gap-2 py-3 bg-white/10 hover:bg-white/20 text-white rounded-xl font-bold transition-all border border-white/10 disabled:opacity-50"
          >
          ...
          <button
            ...
            className="flex items-center justify-center gap-2 px-6 py-3 bg-indigo-600/20 hover:bg-indigo-600/30 text-indigo-400 rounded-xl font-bold transition-all border border-indigo-500/20"
          >
