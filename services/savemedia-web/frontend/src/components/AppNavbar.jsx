...
export default function AppNavbar({
  ...
  return (
    <header className="w-full max-w-[920px] sticky top-3 z-30 mb-8 sm:mb-12">
      <div className="w-full h-14 sm:h-16 px-3 sm:px-5 bg-slate-900/80 backdrop-blur-xl border border-white/10 rounded-2xl shadow-2xl shadow-black/50 flex items-center justify-between">
        ...
        <div className="flex items-center gap-2.5 sm:gap-3 select-none">
          <div className="w-8 h-8 sm:w-9 sm:h-9 rounded-xl bg-gradient-to-tr from-indigo-500 to-violet-600 flex items-center justify-center shadow-md shadow-indigo-500/20 text-white font-black text-sm">
        ...
        <div className="hidden md:flex items-center p-1 bg-slate-950/60 border border-white/10 rounded-xl">
          <button
          ...
          <button
            ...
            className={`flex items-center gap-2 px-4 py-2 rounded-lg text-xs font-semibold transition-all duration-200 cursor-pointer relative ${
              activeTool === 'sticker'
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="relative">
            ...
            >
              ...
              <span className="hidden sm:inline">Telegram Bots</span>
      ...
      {/* Mobile Sub-Switcher */}
      <div className="flex md:hidden items-center justify-center gap-1.5 p-1 mt-3 bg-slate-900/90 border border-white/10 rounded-xl max-w-sm mx-auto shadow-lg">
        <button
          onClick={() => onSelectTool('downloader')}
